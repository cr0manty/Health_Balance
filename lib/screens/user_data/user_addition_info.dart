...
class _UserAdditionInfoScreenState extends State<UserAdditionInfoScreen> {
  ...
  void initState() {
    ...
    _heightController.addListener(() {
      _userAdditionDataBLoC.add(
        UserAdditionDataEvent.heightChanged(_heightController.text),
      );
    });
    _weightController.addListener(() {
      _userAdditionDataBLoC.add(
        UserAdditionDataEvent.weightDateChanged(_weightController.text),
      );
    });
    _wristGirthController.addListener(() {
      _userAdditionDataBLoC.add(
        UserAdditionDataEvent.wristGirthChanged(_wristGirthController.text),
      );
    });
  }
